...
Write-Host "Kafka Laptop 1 : host.docker.internal:9093" -ForegroundColor Gray
...
docker exec -d `
    ...
    -e MINIO_ENDPOINT=rosbd_minio:9000 `
...
Write-Host "  Cek MinIO Console: http://localhost:9001" -ForegroundColor White
Write-Host ""
